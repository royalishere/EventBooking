            ...
            <div id="banner" className="banner-wrapper">
                <div className="container-content">
                    <div className="text-wrapper">
                        ...
                        <div className="text">
                            <div className="info">
                                ...
                                <p id="date"><span id="date-text"><i className="bi bi-calendar-minus"></i> {event.time}</span>
                                </p>
                                <p id="address"><span><i className="bi bi-geo-alt-fill"></i> {event.address}</span></p>
                            </div>
                    ...
                    <div className="img-wrapper">
                        <img src={`\event_${event.id}.jpg`} alt="Banner cover"/>
                    </div>
                </div>
            </div>
            <div className="intro">
